package com.example.emoji.utils.shareutils;
...
public class ShareToolUtil {
    ...
    public static final String AUTHORITY = "com.share.fr.fileprovider";
    ...
    public static File saveSharePic(Context context, byte[] bytes){
